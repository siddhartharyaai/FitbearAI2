...
-- Seed some basic Indian food data
...
('Vegetable Thali', 'complete_meal', 600, 20, 80, 18, 12, 1500);
...
((SELECT id FROM food_items WHERE canonical_name = 'Samosa'), 'samosas', 'en', 95);
